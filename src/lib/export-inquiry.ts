...
// type Booking = z.infer<typeof createBookingSchema>
...
//   static exportSeminarsData(seminars: Seminar[], format: "csv" | "pdf"): void {
//     const headers = ["Title", "Date", "Time", "Duration", "Price", "Capacity", "Status"]
...
//   static exportBookingsData(bookings: Booking[], format: "csv" | "pdf"): void {
//     const headers = [
//       "Booking ID",
//       "User Name",
//       "User Email",
...
//     const headers = ["Name", "Email", "Total Bookings", "Status"]
